    ...
    return (
        <div className='list-products'>
            <h2>{section}</h2>
                ...
                <ItemProduct title='New Balance 550 HR1' price="28.999" image={'new-balance-bb550hr1.jpg'} stock="5"/>
                <ItemProduct title='Nike W Dunk Hi Up PRM' price="39.9999" image={'nike-w-dunk-hi-up-prm-.jpg'} stock="5"/>
